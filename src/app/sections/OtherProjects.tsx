      ...
      const projectInfos = [
            {
                  ...
                  description: <React.Fragment>
                        <p>I wrote this software to serve as a hub for my minecraft plugins. The software allowed my users to purchase, download, review, and get support for plugins.
                              ...
                              Which can be a really big deal when you are building so many endpoints, and you don&apos;t want discrepancies between the frontend and backend&apos;s validation. I also used <Link href={"https://www.docker.com/"}>Docker</Link> to containerize the application and <Link href={"https://www.nginx.com/"}>Nginx</Link> to serve the frontend. I used <Link href={"https://bunny.net"}>BunnyCDN</Link> for
