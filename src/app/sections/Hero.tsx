            ...
            <Fragment>
                  <div className="flex flex-row items-start w-full">
                        <div className='mr-8'>
                              ...
                              <p className="text-lg md:text-xl">I love making ideas come to life with code. I&apos;m a huge fan of <Link href={"https://go.dev/"}>Golang</Link> and <Link href={"https://www.typescriptlang.org/"}>TypeScript</Link>.</p>
